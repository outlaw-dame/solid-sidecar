...
- Phase 12.1 policy semantics parser interface and fixture-backed scaffold.
- Phase 12.2 deterministic fixture lookup by request hash.
- Phase 12.3 parse-all helper for shared semantics fixtures.
- Phase 12.4 parse result metadata validation and JSON schema.
- Phase 12.5 parser scaffold regression tests for match, no-match, cancellation, and determinism.
- Phase 12.6 Phase 12 completion documentation.
- Phase 13.1 WAC fixture-only facts type and validation.
- Phase 13.2 WAC parse-result filtering from the fixture parser scaffold.
- Phase 13.3 deterministic WAC fixture facts generation from shared semantics suites.
- Phase 13.4 WAC fixture facts JSON schema.
- Phase 13.5 WAC fixture facts regression tests for conversion, filtering, parser integration, determinism, validation failures, and cancellation.
- Phase 13.6 Phase 13 completion documentation.

Not implemented yet: authoritative Solid-OIDC issuer/WebID validation, production policy parsing, RDF canonicalization, production policy enforcement, decision caching, notification fan-out.

See `docs/phase-4-completion.md`, `docs/phase-5-completion.md`, `docs/phase-6-completion.md`, `docs/phase-7.md`, `docs/phase-8-completion.md`, `docs/phase-9-completion.md`, `docs/phase-10-completion.md`, `docs/phase-11-completion.md`, `docs/phase-12-completion.md`, and `docs/phase-13-completion.md` for completed-phase guarantees, non-goals, and handoff boundaries.
...
- `internal/authz/`: authorization-contract request builder, codecs, validators, local shadow evaluator, optional external CLI evaluator, evaluator backoff wrapper, policy-input metadata normalization, policy-source metadata normalization, source loading/cache metadata helpers, cache-store adapter contracts, refresh-plan metadata, policy semantics fixture contracts, fixture-backed parser scaffolds, WAC fixture-only facts, privacy-safe aggregate metrics, deterministic audit hashing, privacy-safe shadow observability, structured invalid-contract decisions, and non-enforcing middleware scaffold.
